...
For each story, write two things:
- "why": one short, punchy sentence, this is the teaser someone sees before clicking
- "summary": a fuller explanation, 3 to 5 sentences, that actually tells the story: what happened, who's involved, why it matters, and what might happen next if relevant. Someone reading only this should feel like they understand the story, not like they need to click through to another site.

Respond with ONLY valid JSON, no markdown fences, no preamble, in exactly this shape:
{
  "stories": [
    {"title": "...", "why": "one short punchy sentence", "summary": "3-5 sentence plain-language explanation", "source": "...", "link": "...", "topic": "World | Business | Tech & AI | Science | Culture"}
  ]
}
